...
<%@ include file="/WEB-INF/views/common/nav.jsp" %>
 <header id="mypage-header">
        <div id="mypage-header-title">
            <p id="mypage-header-text">MY PAGE</p>
            <p id="mypage-header-subtext">NMT 내정보 보기</p>
        </div>
    </header>
    <section id="mypage-section">
        ...
        <div id="mypage-section-info">
            <div class="mypage-wrap wrap-height">
                <div class="myinfo-box left">
                    ...
                    <span class="mypage-welcome-name">홍길동</span><span class="mypage-welcome-msg">님</span>
                    <br>
                    <button class="btn-all margin-top">회원정보 수정</button> <br><br>
                    <button class="btn-all">회원 탈퇴</button>
                </div>
                ...
                <div class="myinfo-box bggray myinfo-box-div">
                    <h3>마일리지</h3>
                    <span>2000</span><span>mile</span>
                    <h3>마일리지 사용가능</h3>
                    <button class="btn-all">마일리지사용내역</button>
                </div>            
            </div>
        </div>
        <div name="mypage-section-title">
        ...
        <div class="mypage-wrap mypage-select-result" id="mypage-result-box">            
                ...
                <div><span class="center">2,345,567원</span></div>            
        </div>
