...
<body>
    ...
    <section>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td id="review_content_wrap">
                            <div class="red_circle_rv"></div>
                            <h2>내용</h2>
                            <input type="text" rows="5" cols="50" name="reviewContent" id="reviewContent"  value="<%=r.getBoardContent()%>" readonly>
                        </td>
                    </tr>
                </table>
            </div>
		...
		<%if(memberLoggedIn!=null && (memberLoggedIn.getMemberId().equals("admin")) ) { %>
	        <div class="btn_wrap">
	            <input type="submit" value="수정하기"  id="btn_update_submit" onclick="location.href='<%=request.getContextPath()%>/board/reviewUpdate?boardNo=<%=r.getBoardNo()%>'">
