...
$(document).ready(function () {
    ...
    $.ajax({
    	...
    	success: data => {
    		...
    		$("#second-reviewImg").attr("src","upload/board/"+$view2.boardOrigin);
    		$("#third-reviewImg").attr("src","upload/board/"+$view3.boardOrigin);
            ...
            <div class="hotel_wrap">
               <div class="img_album">
                ...
                <form action="<%=request.getContextPath()%>/travelpackage/hotelContentView" method="get">
                    ...
                    <br>
                    <input type="submit" id="btn_go" value="상품보러가기" <%-- onclick="location.href='<%=request.getContextPath()%>/travelpackage/hotelContentView'" --%>>
                </form>    
                </div>
            </div>
        </div>
